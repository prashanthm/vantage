 ...
 * ```
 */
export declare function CommandPaletteInput({ value: controlledValue, onValueChange, placeholder: placeholderFromProps, hasAutoFocus, endContent, onChange, onKeyDown, ref, xstyle, ...props }: CommandPaletteInputProps): import("react").JSX.Element;
