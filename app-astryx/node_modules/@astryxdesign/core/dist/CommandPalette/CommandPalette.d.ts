 ...
 * ```
 */
export declare function CommandPalette<T extends SearchableItem = SearchableItem>({ ref, isOpen, isInline, onOpenChange, searchSource, input, footer, renderItem, emptySearchText: emptySearchTextFromProps, emptyBootstrapText: emptyBootstrapTextFromProps, value: controlledValue, onValueChange, label: labelFromProps, width, maxHeight, }: CommandPaletteProps<T>): import("react").JSX.Element;
