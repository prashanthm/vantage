// Cockpit — ported from cockpit-astryx/src/main.jsx into the shell (W0),
// recomposed onto the Workbench template: NowCard is the status band,
// the frames table is the focus, checklist/levels/discipline the rail.
// Decision logic is code, never Mira — ported verbatim.
      ...
      <VStack gap={2} padding={2}>
        <HStack gap={2} align="center" justify="between" wrap="wrap">
          ...
          <Text type="supporting" color="secondary">
            ...
            {" · "}<Link href={links.forecastGrading("SPX")}>grading →</Link>
          </Text>
        </HStack>
        {call ? (
          <>
...
export function CockpitPage() {
  ...
  const head = (
    <HStack gap={3} align="center" justify="between" wrap="wrap">
      <VStack gap={0}>
        ...
        <Text type="supporting" color="secondary">
          the market · the analyst&apos;s calls · you · <Link href="/#/home/cockpit">chart + briefings (legacy) →</Link>
        </Text>
      </VStack>
  ...
  return (
    <VStack gap={3}>
      {head}
      <Workbench
        band={<NowCard d={d} isToday={isToday} />}
