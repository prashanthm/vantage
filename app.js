(() => {
  ...
  function SignalBotView({ refreshNonce }) {
    ...
    const load = async () => {
      const [s2, p] = await Promise.all([getBotStatus(), getBotPerformance()]);
